...
1. [mahind2024-*.pdf.en.txt](flow/writeTxt_/output/): Orders in Marathi.

2. [mahind2024-*.pdf.mr.txt](flow/writeTxt_/output/): Orders in English.
...
```
git clone https://github.com/orgpedia/mahind2024.git
```
